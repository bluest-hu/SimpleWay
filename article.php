<div class="post-wrap <?php echo is_single()? "single-post-wrap": "";?> card"  <?php echo is_single()? 'id="singlePostWrap"': "";?>>
    ...
    <article <?php echo is_single()? post_class("single-post") : post_class() ;?> id="post-<?php the_ID();?>">
        <div class="post-top-column post-meta-wrap clear">
            <div class="left-column author-avatar-wrap"><a class="author-avatar" href="<?php echo get_author_posts_url(get_the_author_meta('ID')); ?>" title="文章作者：<?php the_author(); ?>" ><!-- Article Author Begin --><?php echo get_avatar( get_the_author_meta('email'), 50, ""); ?><span class="author-name"><?php the_author(); ?></span></a></div>
            <div class="left-column fix-width">
                <h1 class="post-title top-column"><a class="post-url" href="<?php the_permalink();?>" title="<?php the_title();?>"><?php the_title(); ?></a></h1>
